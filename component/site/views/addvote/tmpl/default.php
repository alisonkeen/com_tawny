...
$statement_list = TawnyHelper::getVotes($question_id, $party_id, $jurisdiction_id, $db);
...
echo "<br/>";
  ...
  if(TawnyUsers::amILoggedIn() == true) {
    ...
    $new_statement->votehistory_id = 0; // start off as 0, 'insert' query will overwrite
    ...
    $new_statement->bill_name    = $jinput->get('bill_name', '', 'STRING');
    echo "<p> Bill Name: " . $new_statement->bill_name . "</p>";

    $new_statement->date    = $jinput->get('date', '', 'STRING');
    echo "<p> Date: " . $new_statement->date . "</p>";
    ...
    $result = TawnyHelper::addVote($new_statement, $db);
